DROP DATABASE IF EXISTS scms_dev;

CREATE DATABASE scms_dev;

USE scms_dev;

CREATE USER 'dev_local' @'%' IDENTIFIED BY 'dev_password@123';

GRANT ALL PRIVILEGES ON scms_dev.* TO 'dev_local' @'%';
